...
* LLM支持：目前通过自定义后端插件方式支持trtllm/vllm，见[grps-trtllm](https://github.com/NetEase-Media/grps_trtllm)，[grps-vllm](https://github.com/NetEase-Media/grps_examples/tree/master/py_examples/vllm)。目前前者兼容OpenAI协议，后者也会进行OpenAI协议兼容。
